...
import {
  TeacherSubjectMarksPanel,
  TeacherSubjectTimetablePanel,
} from '@/components/teacher/teacher-subject-panels';
import {
...
function TeacherSubjectContent() {
  ...
  const classHubHref = assignment ? `/teacher/classes/${assignment.groupId}` : '/teacher/my-classes';
  ...
  return (
    ...
    >
      <TeacherSubjectTabs active={activeTab} assignmentId={assignment.id} />
      ...
      {activeTab === 'marks' && (
        <TeacherSubjectMarksPanel groupId={assignment.groupId} subjectId={assignment.subjectId} />
      )}

      {activeTab === 'timetable' && (
        <TeacherSubjectTimetablePanel groupId={assignment.groupId} subjectId={assignment.subjectId} />
      )}
        ...
        <>
          <div className="teacher-card rounded-xl border border-warm-card-border bg-warm-card p-4">
            <dl className="teacher-dl-grid text-sm">
              ...
              {attendanceSummary && (
                <div>
                  <dt className="text-xs text-warm-muted">30-day attendance</dt>
                  <dd className="text-warm-cream">
